...
define('HEADING_TITLE', 'Страны');

define('TABLE_HEADING_COUNTRY_NAME', 'Страна');
define('TABLE_HEADING_COUNTRY_CODES', 'Код ISO');
...
define('TEXT_INFO_HEADING_DELETE_COUNTRY', 'Удалить страну');
define('ERROR_COUNTRY_IN_USE', 'Ошибка: Нельзя удалить страну, так как она связана с записями покупателей.');
define('ISO_COUNTRY_CODES_LINK', '<a href="http://www.iso.org/iso/country_codes/country_codes" target="_blank">Коды стран ISO 3166</a>');
