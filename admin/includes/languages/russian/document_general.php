...
define('TEXT_NO_CHILD_CATEGORIES_OR_PRODUCTS', 'Введите новую категорию или товар на этом уровне.');
...
define('TEXT_INFO_COPY_TO_INTRO', 'Выберите, пожалуйста, новую категорию, в которую Вы хотите скопировать этот товар');
...
define('TEXT_DOCUMENT_DATE_AVAILABLE', 'Товар доступен с:');
define('TEXT_DOCUMENT_AVAILABLE', 'Доступен');
define('TEXT_DOCUMENT_NOT_AVAILABLE', 'Недоступен');
...
define('TEXT_DOCUMENT_DETAILS', 'Содержание документа:');
define('TEXT_DOCUMENT_IMAGE', 'Картинка документа:');
define('TEXT_DOCUMENT_IMAGE_DIR', 'Загрузить в директорию:');
...
// meta tags
  define('TEXT_META_TAG_TITLE_INCLUDES','<strong>Отметьте какие мета-теги Документа должны быть включены:</strong>');
  define('TEXT_PRODUCTS_METATAGS_PRODUCTS_NAME_STATUS','<strong>Имя документа:</strong>');
