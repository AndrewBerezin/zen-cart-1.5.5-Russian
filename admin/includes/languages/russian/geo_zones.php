...
define('HEADING_TITLE', 'Географические зоны - Налоги, оплата, доставка');

define('TABLE_HEADING_COUNTRY', 'Страна');
define('TABLE_HEADING_COUNTRY_ZONE', 'Регион');
define('TABLE_HEADING_TAX_ZONES', 'Наименование зоны');
define('TABLE_HEADING_TAX_ZONES_DESCRIPTION', 'Описание зоны');
define('TABLE_HEADING_STATUS', 'Статус');
define('TABLE_HEADING_ACTION', 'Действие');
//define('TEXT_LEGEND', 'LEGEND: ');
define('TEXT_LEGEND_TAX_AND_ZONES', ': Определённые Налоги и Зоны');
define('TEXT_LEGEND_ONLY_ZONES', ': Зоны определены, а Налоги нет ');
define('TEXT_LEGEND_NOT_CONF', ': Не сконфигурировано ');

define('TEXT_INFO_HEADING_NEW_ZONE', 'Новая зона');
define('TEXT_INFO_NEW_ZONE_INTRO', 'Введите информацию о новой зоне');

define('TEXT_INFO_HEADING_EDIT_ZONE', 'Редактировать');
define('TEXT_INFO_EDIT_ZONE_INTRO', 'Сделайте необходимые изменения');

define('TEXT_INFO_HEADING_DELETE_ZONE', 'Удалить зону');
...
define('TEXT_INFO_HEADING_DELETE_SUB_ZONE', 'Удалить подзону');
define('TEXT_INFO_DELETE_SUB_ZONE_INTRO', 'Вы действительно хотите удалить эту подзону?');
...
define('TEXT_INFO_NUMBER_ZONES', 'Номер зоны:');
...
define('ERROR_TAX_RATE_EXISTS','Предупреждение: Перед тем как удалить эту зону удалите закрепленную за ней налоговую ставку');
