...
define('TEXT_NO_CHILD_CATEGORIES_OR_PRODUCTS', 'Пожалуйста, добавьте новую категорию или товар');
define('TEXT_PRODUCT_MORE_INFORMATION', 'Для получения подробной информации посетите <a href="%s" target="blank"><u>сайт</u></a> производителя.');
...
define('TEXT_PRODUCT_NOT_AVAILABLE', 'Не активен');
...
define('TEXT_PRODUCTS_MANUFACTURER', 'Бренд:');
...
// Products and Discount Copy Options
  define('TEXT_COPY_DISCOUNTS_ONLY','Используется только для дублирования товаров со скидками ...');
  define('TEXT_COPY_DISCOUNTS','Копировать скидки в дупликат?');
  define('TEXT_COPY_DISCOUNTS_YES','Да');
  define('TEXT_COPY_DISCOUNTS_NO','Нет');
