...
define('TEXT_PRODUCTS_RECORD_ARTIST', 'Исполнитель:');
define('TEXT_PRODUCTS_RECORD_COMPANY', 'Записывающая компания:');
define('TEXT_PRODUCTS_MUSIC_GENRE', 'Музыкальный жанр:');
...
define('TEXT_PRODUCTS_MODEL', 'Артикул товара:');
...
// Products and Attribute Copy Options
  ...
  define('TEXT_COPY_MEDIA_MANAGER','Скопировать любую медиа коллекцию относящуюся к этому товару.');
