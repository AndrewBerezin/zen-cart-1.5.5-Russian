...
define('BUTTON_CREATE_ACCOUNT_ALT', 'Войти');
define('BUTTON_LOG_OFF_ALT', 'Выйти');
define('BUTTON_ADD_TO_CART_ALT', 'Добавить в корзину');
define('BUTTON_ADD_ADDRESS_ALT', 'Добавить адрес');
define('BUTTON_ADD_PRODUCTS_TO_CART_ALT','Добавить выбранные товары в корзину');
define('BUTTON_BACK_ALT', 'Вернуться');
define('BUTTON_BUY_NOW_ALT', 'Купить');
define('BUTTON_CANCEL_ALT', 'Отменить');
define('BUTTON_CHANGE_ADDRESS_ALT', 'Изменить адрес');
define('BUTTON_CHECKOUT_ALT', 'Оформить');
define('BUTTON_CONFIRM_SEND_ALT', 'Послать подарочный сертификат');
define('BUTTON_CONFIRM_ORDER_ALT', 'Подтвердить заказ');
define('BUTTON_CONTINUE_ALT', 'Продолжить');
define('BUTTON_CONTINUE_SHOPPING_ALT', 'Продолжить покупки');
define('BUTTON_DELETE_ALT', 'Удалить');
define('BUTTON_DELETE_SMALL_ALT', 'Удалить');
define('BUTTON_DOWNLOAD_ALT', 'Скачать');
define('BUTTON_EDIT_SMALL_ALT', 'Изменить');
define('BUTTON_IN_CART_ALT', 'В корзину');
define('BUTTON_LOGIN_ALT', 'Войти');
define('BUTTON_LOOKUP_ALT', 'Посмотреть');
define('BUTTON_NEXT_ALT', 'Следующий');
define('BUTTON_PREVIOUS_ALT', 'Предыдущий');
define('BUTTON_REDEEM_ALT', 'Воспользоваться кодом');
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Вернуться к списку товаров');
define('BUTTON_REVIEWS_ALT', 'Перейти на страницу отзывов');
define('BUTTON_SEARCH_ALT', 'Поиск');
define('BUTTON_SEND_ALT', 'Отправить');
define('BUTTON_SEND_ANOTHER_ALT', 'Отправить другой сертификат');
define('BUTTON_SEND_A_GIFT_CERT_ALT', 'Отправить сертификат');
define('BUTTON_SHIPPING_ESTIMATOR_ALT', 'Расчет доставки');
define('BUTTON_SOLD_OUT_ALT', 'Продано');
define('BUTTON_SOLD_OUT_SMALL_ALT', 'Продано');
define('BUTTON_SUBMIT_ALT', 'Подтвердить');
define('BUTTON_UNSUBSCRIBE', 'Отписаться');
define('BUTTON_UPDATE_ALT', 'Обновить');
define('BUTTON_VIEW_SMALL_ALT', 'Просмотр');
define('BUTTON_WRITE_REVIEW_ALT', 'Написать отзыв');
define('BUTTON_READ_REVIEWS_ALT', 'Прочитать отзыв');
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'Подробнее');
define('BUTTON_MORE_REVIEWS_ALT', 'Остальные отзывы');
define('BUTTON_VIEW_ALL_ALT', 'Смотреть все');
