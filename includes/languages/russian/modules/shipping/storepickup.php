...
define('MODULE_SHIPPING_STOREPICKUP_TEXT_TITLE', 'Самовывоз');
define('MODULE_SHIPPING_STOREPICKUP_TEXT_DESCRIPTION', 'Самовывоз из магазина');
define('MODULE_SHIPPING_STOREPICKUP_TEXT_WAY', 'Самовывоз из магазина');
