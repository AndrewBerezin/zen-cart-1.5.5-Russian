...
define('TEXT_COUPON_HELP_FIXED', '<br /><br />Купон стоимостью %s может быть использован для оплаты Вашего заказа');
define('TEXT_COUPON_HELP_MINORDER', '<br /><br />Вам можно потратить %s, чтобы использовать Купон');
