...
define('TEXT_ADMIN_SETUP_USER_PASSWORD_HELP', '<strong>ВНИМАНИЕ!!</strong>: Ниже указан начальный временный пароль учетной записи администратора-суперпользователя. Обяхательно сохраните его в надёжном месте! Будьте внимательны!');
