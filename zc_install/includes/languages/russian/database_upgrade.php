 ...
 */
  define('TEXT_PAGE_HEADING', 'Zen Cart&reg; Setup - Обновление базы данных');
  define('UPDATE_DATABASE_NOW','Обновить базу данных сейчас');//this comes before TEXT_MAIN
  ...
  define('DATABASE_TYPE', 'Тип БД');
  define('DATABASE_HOST', 'Хост БД');
  define('DATABASE_USERNAME', 'Пользователь БД');
  define('DATABASE_PASSWORD', 'Пароль БД');
  define('DATABASE_NAME', 'Имя БД');
  define('DATABASE_PREFIX', 'Префикс таблиц БД');
  ...
  define('TITLE_DATABASE_PREFIX_CHANGE','Изменить префикс таблиц базы данных');
  ...
  define('DATABASE_OLD_PREFIX','Старый префикс таблиц');
  define('DATABASE_OLD_PREFIX_INSTRUCTION','Enter the OLD Table-Prefix');
  define('ENTRY_NEW_PREFIX','Новый префикс таблиц ');
  ...
  define('ENTRY_ADMIN_PASSWORD','Пароль');
